...
export default function ProcessChains() {
  ...
  const handleBtnClick = (
    ...
    if (command === "gotoProcessChain") {
      setOpenHopModal(false); // hide hop modal
      setOpen(!open); // show process chain modal
    }
    if (command === "gotoHopTemplate") {
      setOpen(false); // hide process chain modal
      setOpenHopModal(!openHopModal); // show hop template modal
    }

    if (command === "closeProcessChainModal") {
      setSelectedHopTemplate(null); // clear the selectedHopTemplate state
      setOpen(false); // hide the process chain modal
      setOpenHopModal(!openHopModal); // show hop template modal
    }
  };
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  <div>
                    ...
                    <div className="mt-5 sm:mt-6">
                      <button
                        type="button"
                        disabled={!selectedHopTemplate?.value && true}
                  ...
                  <form onSubmit={onSubmit}>
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <div className="mt-2">
                          ...
                          <div className="mt-3">
                            <Tooltip
                              title={selectedHopTemplate?.path}
                              placement="right"
                            >
                              <div>
                                <TextInput
                    ...
                    <div className="mt-5 sm:mt-6 flex space-x-2">
                      <button
                        type="button"
                        onClick={(e) =>
                          handleBtnClick(e, "closeProcessChainModal")
                        }
