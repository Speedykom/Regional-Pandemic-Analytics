...
class Dag(models.Model):
    ...
    def __str__(self):  
        return "Dag(id={}, dag_name={}, dag_id={}, parquet_path={}, data_source_name={}, schedule_interval={}, path={})".format(self.id, self.dag_name, self.dag_id, self.parquet_path, self.data_source_name, self.schedule_interval, self.path)