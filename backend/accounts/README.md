...
These docs describes how to use the [IGAD Account](https://data2.train-cohis.minsante.cm) API. We hope you enjoy these docs, and please don't hesitate to file an issue if you see anything missing.
...
Base URL: https://data2.train-cohis.minsante.cm/api
