...
with DAG('Testing-123', default_args=default_args, schedule_interval='@monthly', catchup=False, is_paused_upon_creation=False) as dag:
    ...
    hop = DockerOperator(
        ...
        environment={
            'HOP_LOG_LEVEL': 'Basic',
            'HOP_FILE_PATH': '${PROJECT_HOME}/Volumes/Disk/Work/speedykom/Regional-Pandemic-Analytics/hop/pipelines/templates/Reading-Data-From-API.hpl',
