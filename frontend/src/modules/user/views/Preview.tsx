...
import {
  ...
  ToMonthDayYear,
} from '@/common/utils/date-converter';
        ...
        <div className="md:flex no-wrap md:-mx-2">
          ...
          <div className="w-full md:w-3/12 md:mx-2">
            ...
            <div className="bg-white p-3 border-t-4 border-green-400">
              <img className="h-32 w-32 rounded-md" src="/avater.png" alt="" />
              ...
              <div className="grid">
                <div>
                  ...
                  <ul className="list-inside space-y-2">
                    <li>
                      <div className="text-teal-600">Manage</div>
                      <div className="text-gray-500 text-xs">View</div>
                    </li>
                    <li>
                      <div className="text-teal-600">Map Roles</div>
