const getTooltipPoint = (element: { getBoundingClientRect: () => any; offsetWidth: number; offsetHeight: number; }, tooltip: { offsetWidth: number; offsetHeight: number; }, position: string, space: number, arrowLength = 0) => {
...
const getArrowBoxPoint = (element: { getBoundingClientRect: () => any; offsetWidth: number; offsetHeight: number; }, tooltip: any, position: string, space: number, arrowLength = 0) => {
  const eleRect = element.getBoundingClientRect();
  const pt = { x: 0, y: 0 };
  switch (position) {
    case "bottom": {
