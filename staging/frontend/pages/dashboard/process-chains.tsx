...
export default function ProcessChains(){
    ...
    const onSubmit = handleSubmit((data) => {
        ...
        axios.post('https://data2.igad-health.eu/api/airflow/', dagData, {
            auth:{
                username: 'admin',
                password: 'back@123'
            }
                                    ...
                                    <form onSubmit={onSubmit}>
                                        <div>
                                            ...
                                            <div className="mt-3 text-center sm:mt-5">
                                                ...
                                                <div className="mt-2">
                                                    <div>
                                                        <TextInput icon={AdjustmentsHorizontalIcon} placeholder="Name of Process Chain" {...register('dagName')} />
                                                    </div>
                                                    <div className="mt-3">
                                                        <TextInput icon={FingerPrintIcon} placeholder="Process Chain ID" {...register('dagID')}/>
                                                    </div>
                                                    <div className="mt-3">
                                                        <TextInput icon={ChevronDoubleRightIcon} placeholder="Path to Process Chain" {...register('dagPath')}/>
                                                    </div>
                                                    <div className="mt-3">
                                                        <TextInput icon={ClockIcon} placeholder="Schedule Interval" {...register('scheduleInterval')}/>
                                                    </div>
                                                    <div className="mt-3">
                                                        <TextInput icon={ClockIcon} placeholder="Parquet Path" {...register('parquetPath')}/>
                                                    </div>
                                                    <div className="mt-3">
                                                        <TextInput icon={ClockIcon} placeholder="Data Source Name" {...register('dataSource')}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
