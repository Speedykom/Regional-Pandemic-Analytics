...
from roles.utils import (
    User_pers, FALSE_User_pers, Role_pers, FALSE_Role_pers, Dashboard_pers, FALSE_dashboard_pers, Chart_pers,
    FALSE_chart_pers,
...
class GetEditRole(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if type == None:
            ...
            return Response({'errorMessage': 'query param type must either be `name` or `id`'},
