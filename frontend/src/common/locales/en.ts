const enTranslation = {
  ...
  tokens: {
    ...
    tokenNamePlaceholder: 'Enter a descriptive name for your token',
    expiration: 'Expiration',
    optional: 'Optional',
    selectExpirationDate: 'Select expiration date',
    neverExpiresHint: 'Leave empty for a token that never expires',
    ...
    tokenCreatedMessage:
      'Your token "{{tokenName}}" has been created. Please copy and save it securely as it won\'t be shown again.',
    tokenCreatedSuccess: 'Token created successfully',
    ...
    tokenExpiration: 'Token Expiration (Optional)',
    ...
    createFirstToken:
      'Create your first token to start sharing datasets securely',
    noDatasetsAvailable:
      'No datasets available. Upload datasets first to create tokens.',
