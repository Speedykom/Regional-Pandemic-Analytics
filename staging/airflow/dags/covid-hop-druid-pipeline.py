...
default_args = {
    'owner': 'airflow',
    'description': 'covid-hop-druid-pipeline',
...
with DAG('covid-hop-druid-pipeline', default_args=default_args, schedule_interval='@daily', catchup=False, is_paused_upon_creation=False) as dag:
    ...
    hop = DockerOperator(
        task_id='hop_task',
        image='apache/hop',
        container_name='covid-hop-druid-pipeline',
        api_version='auto',
        auto_remove=True,
        host_tmp_dir='/files',
        mount_tmp_dir=False,
