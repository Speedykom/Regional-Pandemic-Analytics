...
class PipelineListView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            logger.error(err)
            return Response({"status": "fail", "message": err}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
    ...
    def post(self, request):
        ...
        try:
            ...
            logger.error(f"file already exists with the name {name}")
            ...
            logger.user_info("Pipeline created successfully", client_result)
...
class PipelineDetailView(APIView):
    ...
    def get(self, request, name=None):
        ...
        try:
            ...
            logger.error("Something went wrong while attempting to fetch pipeline {}".format(name), err)
    ...
    def put(self, request, name=None):
        ...
        try:
            ...
            logger.user_info("Update pipeline file in Minio", {"name": name})
