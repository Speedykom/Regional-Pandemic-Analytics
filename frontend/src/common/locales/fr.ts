const frTranslation = {
  ...
  tokens: {
    ...
    tokenNamePlaceholder: 'Entrez un nom descriptif pour votre jeton',
    expiration: 'Expiration',
    optional: 'Optionnel',
    selectExpirationDate: "Sélectionner la date d'expiration",
    neverExpiresHint: "Laissez vide pour un jeton qui n'expire jamais",
    ...
    copied: 'Copié !',
    close: 'Fermer',
    tokenCreatedSuccessfully: 'Jeton créé avec succès',
    tokenCreatedMessage:
      'Votre jeton "{{tokenName}}" a été créé. Veuillez le copier et le sauvegarder en toute sécurité car il ne sera plus affiché.',
    tokenCreatedSuccess: 'Jeton créé avec succès',
    failedToCreateToken: 'Échec de la création du jeton',
    pleaseEnterTokenName: 'Veuillez entrer un nom de jeton',
    pleaseSelectDataset:
      'Veuillez sélectionner au moins un ensemble de données',
    copyToClipboard: 'Copier dans le presse-papiers',
    copiedToClipboard: 'Copié dans le presse-papiers !',
    tokenCreated: 'Jeton créé avec succès',
    tokenExpiration: 'Expiration du jeton (Optionnel)',
    neverExpires: "N'expire jamais",
    deleteSuccess: 'Jeton supprimé avec succès',
    deleteError: 'Échec de la suppression du jeton',
    createError: 'Échec de la création du jeton',
    noTokensFound: 'Aucun jeton trouvé',
    createFirstToken:
      'Créez votre premier jeton pour commencer à partager des données en toute sécurité',
    noDatasetsAvailable:
      "Aucun ensemble de données disponible. Téléchargez d'abord des ensembles de données pour créer des jetons.",
    tokenDetails: 'Détails du jeton',
    associatedDatasets: 'Ensembles de données associés',
