...
```bash
0 */6 * * * cd /home/cohis/Regional-Pandemic-Analytics && docker compose --env-file ./.env.prod -f docker-compose.yml -f docker-compose.prod.yml exec -d nginx nginx -s reload
```
