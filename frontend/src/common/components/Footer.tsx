        ...
        <div className="px-4 flex flex-col md:flex-row items-center justify-between text-gray-600">
          <div className="mb-4 md:mb-0 flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
            <ul className="mb-4 md:mb-0 flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
              <li>
                <Link href="footer/learn-more" className="text-prim">Learn More</Link>
              </li>
              <li>
                <Link href="footer/privacy" className="text-prim">Privacy</Link>
              </li>
              <li>
                <Link href="footer/terms-of-service" className="text-prim">Terms of Service</Link>
              </li>
              <li>
                <Link href="footer/business-agreement" className="text-prim">Business Agreement</Link>
              </li>
            </ul>
          </div>
